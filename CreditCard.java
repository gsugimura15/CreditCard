...
{  
  ...
  {
    if (num.length() >= 12 && num.length() <=16) // Only works if the card has a certain number of digits
    {
    int a = 0; // placeholder
    int b = 0; // placeholder
 ...
 public int findType(String num1) // String to figure out the type of card. Starting numbers and gathered and a type of card is returned. 
 {
